...
QT_MOC_LITERAL(1, 4, 3), // "win"
QT_MOC_LITERAL(2, 8, 0), // ""
QT_MOC_LITERAL(3, 9, 4), // "lose"
QT_MOC_LITERAL(4, 14, 10), // "stepchange"
QT_MOC_LITERAL(5, 25, 11), // "scorechange"
QT_MOC_LITERAL(6, 37, 12) // "hscorechange"

    },
    "Box\0win\0\0lose\0stepchange\0scorechange\0"
    "hscorechange"
};
...
void Box::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->stepchange(); break;
        case 3: _t->scorechange(); break;
        case 4: _t->hscorechange(); break;
        default: ;
        }
        ...
        {
            using _t = void (Box::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Box::win)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Box::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Box::lose)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Box::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Box::stepchange)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Box::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Box::scorechange)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Box::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Box::hscorechange)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 3
void Box::scorechange()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void Box::hscorechange()
{
