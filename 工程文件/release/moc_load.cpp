...
QT_MOC_LITERAL(3, 12, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(4, 36, 21) // "on_pushButton_clicked"

    },
    "load\0start\0\0on_pushButton_2_clicked\0"
...
void load::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (load::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&load::start)) {
                *result = 0;
                return;
            }
        }
